...
handles.hiddenlayerlistlength = 0;
...
for i = 1:handles.nrofiterations
 ...
 handles.hiddenlayerlistlength = handles.hiddenlayerlistlength + 1;
 for j = 1:handles.nrofassocnethiddenunits
  handles.hiddenlayerlist(handles.hiddenlayerlistlength, j) = handles.assocnethiddenunits(j);
 end
...
for i = 1:handles.nrofwordreps
 ...
 testhiddenlayerlistlength = testhiddenlayerlistlength + 1;
 for j = 1:handles.nrofassocnethiddenunits
  testhiddenlayerlist(testhiddenlayerlistlength,j) = handles.assocnethiddenunits(j);
 end
...
if handles.trajectories2d == 1
  ...
  [hiddenlayerlist2d, eigvect, eigval, variances] = pca(handles.hiddenlayerlist, 0, 2);
  ...
  [testhiddenlayerlist2d, eigvect, eigval, variances] = pca(testhiddenlayerlist, 0, 2);
 ...
 if handles.trajectories3d == 1
  ...
  ax = gca;
  % Reduce dimensionality of training hidden layers
  [hiddenlayerlist3d, eigvect, eigval, variances] = pca(handles.hiddenlayerlist, 0, 3);
  % Plot all training hidden layers  
  for i = 1:handles.nrofiterations
  ...
  % Reduce dimensionality of test hidden layers
  [testhiddenlayerlist3d, eigvect, eigval, variances] = pca(testhiddenlayerlist, 0, 3);
...
dlmwrite('assocreps.txt',testhiddenlayerlist, 'delimiter', '\t', 'precision','%.3f', 'newline', 'pc');
disp ('Complete');
guidata (gcbo, handles);
