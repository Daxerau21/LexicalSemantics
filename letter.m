...
for i = 1:handles.nrofiterations
 ...
 for j = 1:handles.nrofletternethiddenunits
  handles.hiddenlayerlist(handles.hiddenlayerlistlength, j) = handles.letternethiddenunits(j);
 end
...
for i = 1:handles.nroflettercodes
 ...
 % Save hidden layer
 for j = 1:handles.nrofletternethiddenunits
  testhiddenlayerlist(i,j) = handles.letternethiddenunits(j);
 end
end
...
dlmwrite('letterreps.txt',testhiddenlayerlist, 'delimiter', '\t', 'precision','%.3f', 'newline', 'pc');
guidata (gcbo, handles);
